...
insurance <- read.csv("../data/InsuranceDataset.csv")
```
...
Perform bivariate analyses on the quantitative variables (direction, strength and form). Describe the linear association between variables. 
